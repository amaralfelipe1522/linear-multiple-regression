...
#%% Análise do coeficiente de correlação de Pearson (-1 ate +1)
...
# tempo = alpha + beta * (distancia percorrida km)
# tempo = 5.87 + 1.41 * (6)
# tempo = 5.87 + 8.46
# tempo = 14.33 (minutos)

# Teste F (ANOVA) da regressão
# Prob(p-valor) = 0.000314
# Nível de significancia adotado geralmente é 5%
# Logo, o modelo é bom, pois o Beta 0.000314 < 0.05
# Distancia exerce uma influencia estatisticamente significativa no tempo

# Teste T
# Semelhante ao Teste F, mas olha tb para o Alpha
# Exemplo: 0.231 > 0.05
# Não se remove o Alpha mesmo se não trazer significancia ao modelo

sm.stats.anova_lm(reg_simples)

#%% Análise do coeficiente de explicação (R²)
# Varia de 0 a 1
# O quanto X explica Y
...
# No exemplo acima, a pessoa levaria 48.45min para percorrer 30km
# Evite a extrapolação na predição, mantendo sempre entre o valor minimo e maximo do valor X
# Aqui por exemplo as distancias variam de 5km(MIN) a 32km(MAX)
